...
- 🎯 Entry points to execute your program using `python -m <template_pipeline>` or `$ template_pipeline` with basic CLI argument parsing.
...
```bash
pip install template_pipeline
```

## Usage

```py
from template_pipeline import BaseClass
from template_pipeline import base_function
